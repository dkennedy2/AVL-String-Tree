...
public class Testingmain {
	...
	sumloop = userinput.nextInt();
		...
		System.out.println("Once the class size has been entered, the program will create a grading curve and print the new grades out at the end.");			
		...
		if (index == size){																	//code runs if index of array equals size of class
			...
			for (int i = 0; i < Array.length; i++) 										//Loops though the scores in array and assigns the corresponding letter grade into Arraygrades
				if (Array[i] < D){
						Arraygrades[i]= "F";

...
public class testingclass {
	...
	int burgercost, drinkcost, friescost, dessertcost;		 // The price of food items
	int burgernum, drinknum, friesnum, dessertnum; 			 // Number of food items ordered
	int burgertotal, drinktotal, friestotal, desserttotal;	 // Price of all food items ordered
	double	foodcost;
	...
	foodcost = (burgertotal + drinktotal + friestotal + desserttotal) + ((burgertotal + drinktotal + friestotal + desserttotal)*.05) + 500;

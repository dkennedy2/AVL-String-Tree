...
public class classtutorial {
	...
	private int elevatorposition;//Floor elevator is located.
	...
	public void sendelevator() {						//not used
		if(elevatorposition < passengerstart) {
			elevatordirection = "up";
	}else if (elevatorposition > passengerstart) {
			elevatordirection = "down";
		...
		System.out.println("The elevator moves " + elevatordirection + " from floor " + elevatorposition + " to " + passengerstart);
		elevatorposition = passengerstart;
	}
	...
	public void direction() {					//not used
		if(elevatorposition < passengerstart) {
				elevatordirection = "up";
		}else if (elevatorposition > passengerstart) {
				elevatordirection = "down";
	...
	public void direction2() {					//not used
			if(elevatorposition < passengerdestination) {
					elevatordirection = "up";
			}else if (elevatorposition > passengerdestination) {
					elevatordirection = "down";
			}else { 
